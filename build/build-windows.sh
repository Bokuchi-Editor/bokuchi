...
# セットアップファイルの生成を確認
SETUP_FILE="src-tauri/target/x86_64-pc-windows-gnu/release/bundle/nsis/Bokuchi_1.1.2_x64-setup.exe"
...
echo "   インストーラー: src-tauri/target/x86_64-pc-windows-gnu/release/bundle/nsis/Bokuchi_1.1.2_x64-setup.exe"
echo ""
echo "🎉 ビルドが正常に完了しました！"
